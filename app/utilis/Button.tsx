  ...
  return (
    <div className="flex items-center gap-4 select-none">
      ...
      <a href="#services" className="hidden sm:inline-block">
        <button className="group relative overflow-hidden rounded-full border border-blue-600/20 bg-transparent px-6 py-3.5 text-blue-600 transition-colors duration-500 hover:border-blue-600 focus:outline-none">
          ...
          <span className="absolute inset-0 z-0 bg-blue-600 translate-y-full transition-transform duration-500 ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:translate-y-0" />
        </button>
      </a>

      {/* PRIMARY BUTTON (Se connecter) */}
      <a href="#about" className="inline-block">
        <button className="group relative overflow-hidden rounded-full bg-blue-600 px-6 py-3.5 text-white border border-blue-600 transition-transform duration-300 active:scale-95 focus:outline-none">
